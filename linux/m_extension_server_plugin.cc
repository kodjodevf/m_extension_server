...
G_DEFINE_TYPE(MExtensionServerPlugin, m_extension_server_plugin, g_object_get_type())
...
static void m_extension_server_plugin_class_init(MExtensionServerPluginClass* klass) {
...
void m_extension_server_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
